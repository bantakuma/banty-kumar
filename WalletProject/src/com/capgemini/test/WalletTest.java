...
import com.capgemini.service.InsufficientBalanceException;
...
public class WalletTest {
	...
	@Test()
	public void WhenCorrectDetailsEnteredItShouldWithdrawTheAmount() throws FieldCannotBeNullException, MobileNumberAlreadyExistsException, PhoneNumberDoesNotExistException, InSufficientBalanceException, InsufficientBalanceException
	{
		walletService.createAccount("ABC", "9999999999", new BigDecimal(500));
	...
	@Test(expected=com.capgemini.exception.PhoneNumberDoesNotExistException.class)
	public void WhenMobileNumberIsIncorrectItShouldWithdrawThrowException() throws FieldCannotBeNullException, MobileNumberAlreadyExistsException, PhoneNumberDoesNotExistException, InSufficientBalanceException, InsufficientBalanceException
	{
		walletService.createAccount("ABC", "9999999999", new BigDecimal(500));
	...
	public void WhenBalanceIsInsufficientItShouldWithdrawThrowException() throws FieldCannotBeNullException, MobileNumberAlreadyExistsException, PhoneNumberDoesNotExistException, InSufficientBalanceException, InsufficientBalanceException
	{
		walletService.createAccount("ABC", "9999999999", new BigDecimal(500));
